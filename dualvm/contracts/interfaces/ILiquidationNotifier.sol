...
/// interface can be registered as the `liquidationNotifier` on LendingEngine.
...
interface ILiquidationNotifier {
    ...
    /// @param correlationId A unique identifier linking this liquidation to its event trace.
